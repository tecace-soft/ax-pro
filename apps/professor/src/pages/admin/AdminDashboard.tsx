            ...
            {location.pathname === '/admin/knowledge-management' ? (
              ...
              <>
                ...
                <div className="ai-research-stats-section" style={{ display: newSectionsExpanded ? 'block' : 'none' }}>
                  ...
                  {/* Top Half - Radar Chart and Timeline (2 columns) */}
                  <div style={{ 
                    display: 'grid', 
                    ...
                    <div style={{
                      ...
                      <div style={{ width: '200px', height: '200px', marginTop: '20px' }}>
                        <svg width="200" height="200" viewBox="0 0 200 200">
                          {/* Background circles */}
                          <circle cx="100" cy="100" r="80" fill="none" stroke="var(--admin-border)" strokeWidth="1" opacity="0.3"/>
                          <circle cx="100" cy="100" r="60" fill="none" stroke="var(--admin-border)" strokeWidth="1" opacity="0.3"/>
                          <circle cx="100" cy="100" r="40" fill="none" stroke="var(--admin-border)" strokeWidth="1" opacity="0.3"/>
                          <circle cx="100" cy="100" r="20" fill="none" stroke="var(--admin-border)" strokeWidth="1" opacity="0.3"/>
                          
                          {/* Radar lines */}
                          <line x1="100" y1="20" x2="100" y2="180" stroke="var(--admin-border)" strokeWidth="1" opacity="0.3"/>
                          <line x1="20" y1="100" x2="180" y2="100" stroke="var(--admin-border)" strokeWidth="1" opacity="0.3"/>
                          <line x1="35.36" y1="35.36" x2="164.64" y2="164.64" stroke="var(--admin-border)" strokeWidth="1" opacity="0.3"/>
                          <line x1="164.64" y1="35.36" x2="35.36" y2="164.64" stroke="var(--admin-border)" strokeWidth="1" opacity="0.3"/>
                          
                          {/* Performance area */}
                          <polygon 
                            points="100,40 140,60 160,100 140,140 100,160 60,140 40,100 60,60" 
                            fill="rgba(59, 230, 255, 0.2)" 
                            stroke="var(--admin-primary)" 
                            strokeWidth="2"
                          />
                          
                          {/* Data points */}
                          <circle cx="100" cy="40" r="4" fill="var(--admin-primary)"/>
                          <circle cx="140" cy="60" r="4" fill="var(--admin-primary)"/>
                          <circle cx="160" cy="100" r="4" fill="var(--admin-primary)"/>
                          <circle cx="140" cy="140" r="4" fill="var(--admin-primary)"/>
                          <circle cx="100" cy="160" r="4" fill="var(--admin-primary)"/>
                          <circle cx="60" cy="140" r="4" fill="var(--admin-primary)"/>
                          <circle cx="40" cy="100" r="4" fill="var(--admin-primary)"/>
                          <circle cx="60" cy="60" r="4" fill="var(--admin-primary)"/>
                        </svg>
                      </div>
                    ...
                    <div style={{
                      ...
                      <div style={{ flex: 1, position: 'relative' }}>
                        <svg width="100%" height="100%" viewBox="0 0 300 200">
                          {/* Grid lines */}
                          {[0, 1, 2, 3, 4].map(i => (
                            <line key={i} x1="0" y1={40 + i * 30} x2="300" y2={40 + i * 30} stroke="var(--admin-border)" strokeWidth="1" opacity="0.2"/>
                          ))}
                          
                          {/* Performance line */}
                          <polyline 
                            points="20,160 60,140 100,120 140,100 180,80 220,70 260,60 280,50" 
                            fill="none" 
                            stroke="var(--admin-primary)" 
                            strokeWidth="3"
                          />
                          ...
                          {[
                            ...
                            <g key={i}>
                              <circle cx={point.x} cy={point.y} r="4" fill="var(--admin-primary)"/>
                              <text x={point.x} y={point.y - 10} textAnchor="middle" fontSize="10" fill="var(--admin-text-muted)">
                                {point.value}%
                              </text>
                            </g>
                          ))}
                          ...
                          {[100, 80, 60, 40, 20].map((value, i) => (
                            <text key={i} x="5" y={45 + i * 30} fontSize="10" fill="var(--admin-text-muted)">
                              {value}%
                            </text>
                          ))}
                        </svg>
                  ...
                  <div style={{ 
                    ...
                    <div style={{
                      background: 'linear-gradient(135deg, var(--admin-primary), var(--admin-primary-600))',
                      borderRadius: '12px',
                      padding: '20px',
                      display: 'flex',
                      flexDirection: 'column',
                      ...
                      <div style={{ fontSize: '48px', fontWeight: 700, marginBottom: '8px' }}>1,247</div>
                    ...
                    <div style={{
                      ...
                      <div style={{ width: '80px', height: '80px', marginBottom: '12px' }}>
                        <svg width="80" height="80" viewBox="0 0 80 80">
                          <circle cx="40" cy="40" r="35" fill="none" stroke="var(--admin-border)" strokeWidth="6" opacity="0.3"/>
                          <circle cx="40" cy="40" r="35" fill="none" stroke="var(--admin-success)" strokeWidth="6" 
                      ...
                      <div style={{ fontSize: '24px', fontWeight: 700, color: 'var(--admin-success)', marginBottom: '4px' }}>78%</div>
                      <div style={{ fontSize: '12px', color: 'var(--admin-text-muted)', textAlign: 'center' }}>
                        Avg. participation
                      </div>
                    </div>

                    {/* Tile 3 - Research Fields */}
                    <div style={{
                      background: 'var(--admin-card-bg)',
                      border: '1px solid var(--admin-border)',
                      borderRadius: '12px',
                      ...
                      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                        {[
                          { name: 'Machine Learning', progress: 85, color: 'var(--admin-primary)' },
                          { name: 'Deep Learning', progress: 72, color: 'var(--admin-success)' },
                          { name: 'NLP', progress: 68, color: 'var(--admin-accent)' },
                          { name: 'Computer Vision', progress: 91, color: '#f59e0b' }
                        ].map((field, i) => (
                          <div key={i} style={{ marginBottom: '8px' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                              <span style={{ fontSize: '11px', color: 'var(--admin-text)' }}>{field.name}</span>
                              <span style={{ fontSize: '11px', color: 'var(--admin-text-muted)' }}>{field.progress}%</span>
                            </div>
                            <div style={{ 
                              height: '4px', 
                    ...
                    <div style={{
                      ...
                      <div style={{ fontSize: '48px', fontWeight: 700, marginBottom: '8px' }}>4.6</div>
                      <div style={{ fontSize: '12px', opacity: 0.8, textAlign: 'center', marginBottom: '8px' }}>
                        ★★★★★
                      </div>
                      <div style={{ fontSize: '12px', opacity: 0.8, textAlign: 'center' }}>
